...
contentHearderF=open("board_frontpage_header_template.html","r");

contentContentF=open("boardcontents_template.html","r");

contentEntryF=open("entry_template.html","r");

contentFooterF=open("board_frontpage_footer_template.html","r");
...
class BlackboardServer(HTTPServer):
	...
	def add_value_to_store(self, value):
		...
		self.current_key += 1
		self.stored[self.current_key]=value
	#------------------------------------------------------------------------------------------------------
...
class BlackboardRequestHandler(BaseHTTPRequestHandler):
	...
	def do_GET_Index(self):
		...
		html_reponse =contentHearderF.read()+contentContentF.read()+contentEntryF.read()+contentEntryF.read()+contentFooterF.read()
		...
		contentHearderF.close();
		contentContentF.close();
		contentEntryF.close();
		contentFooterF.close();
	#------------------------------------------------------------------------------------------------------
